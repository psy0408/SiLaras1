...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <div class="menu-item active">REPORT</div>
            ...
            <table class="reports-table">
                ...
                <tbody id="reportsTableBody">
                    <tr data-status="pending">
                        ...
                        <td>
                            <button class="btn-edit" onclick="editReport('001')">Edit</button>
                        </td>
                    ...
                    <tr data-status="pending">
                        ...
                        <td>
                            <button class="btn-edit" onclick="editReport('002')">Edit</button>
                        </td>
                        <td class="action-buttons">
                    ...
                    <tr data-status="diproses">
                        ...
                        <td>
                            <button class="btn-edit" onclick="editReport('003')">Edit</button>
                        </td>
                        <td class="action-buttons">
    ...
    <script>
        ...
        function editReport(reportId) {
            alert(`Mengedit Laporan #${reportId}`);
            // window.location.href = `report-edit.html?id=${reportId}`;
        }
        ...
        document.querySelectorAll('.menu-item').forEach(item => {
            item.addEventListener('click', function() {
                if (this.textContent.trim() === 'REPORT') return;
